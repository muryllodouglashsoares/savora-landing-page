...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Savora — Cozinha contemporânea" },
      {
        name: "description",
        content:
          "Savora: restaurante contemporâneo com cardápio digital, reservas e cozinha de fogo nos Jardins, São Paulo.",
      },
      { property: "og:site_name", content: "Savora" },
    ...
    links: [
      ...
      // Fotos do cardápio vêm do Unsplash: abrir a conexão adiantado evita que
      // a primeira troca de categoria pague o custo de DNS + TLS na hora.
